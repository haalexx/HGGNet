...
from models.transformer import decTransformer, decTransformer_self
...
class FPT_UpsampleBlock(nn.Module):
    def __init__(self, in_channels, up_channels, fp_mlp, out_channels, global_channels):
        ...
        self.transformer = decTransformer_self(in_channels=fp_mlp[-1], out_channels=out_channels,
    ...
    def forward(self, up_xyz, xyz, up_features, features, global_features):
        ...
        out_features = self.transformer(up_xyz, new_features)
